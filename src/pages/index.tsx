  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless travel planning with Flight Booking Application - Your one-stop solution to book and save big on every flight via ABC."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1483450388369-9ed95738483c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmbGlnaHQlMkJib29raW5nfGVufDB8fHx8MTY5ODMyODQ5OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@by_syeoni?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Suhyeon Choi`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless travel planning with Flight Booking Application - Your one-stop solution to book and save big on every flight via ABC.`}
            </Text>
            <Box
